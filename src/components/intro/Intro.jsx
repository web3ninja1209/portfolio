    ...
    <div className="i">
      <div className="i-left">
        <div className="i-left-wrapper">
          ...
          <h1 className="i-name">Rajat Ratewal</h1>
          <div className="i-title">
            <div className="i-title-wrapper">
              <div className="i-title-item">Enterprenure / Writer</div>
              <div className="i-title-item">Full Stack Developer</div>
              <div className="i-title-item">UI/UX Designer</div>
              <div className="i-title-item">Content Creator</div>
              <div className="i-title-item">H/W Product Design</div>
            </div>
          </div>
          <p className="i-desc">
          ...
          <br/>
          - Rajat Ratewal: <a className="i-anchor" href="https://www.linkedin.com/in/rajatratewal/">Linkedin</a>
          </p>
        </div>
        <svg
          width="75"
